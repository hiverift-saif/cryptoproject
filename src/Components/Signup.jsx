    ...
    <div className="min-h-screen flex items-center justify-center bg-black px-4 py-12 font-sans">
      ...
      <div className="w-full max-w-md bg-[#09090b] border border-white/10 rounded-2xl p-8 shadow-2xl relative z-10">
        ...
        <div className="flex items-center gap-4 mb-6">
          ...
          <span className="text-white/30 text-xs uppercase">Or with email</span>
          <div className="h-px bg-white/10 flex-1"></div>
        </div>
        ...
        <form className="space-y-4">
          <div className="space-y-1">
            ...
            <div className="relative group">
              ...
              <input type="text" placeholder="John Doe" className="w-full bg-[#18181b] border border-white/10 rounded-xl px-11 py-3 text-white placeholder:text-white/20 focus:outline-none focus:border-[#ffae34]/50 focus:ring-1 focus:ring-[#ffae34]/50 transition-all text-sm" />
            </div>
          </div>
          ...
          <div className="space-y-1">
            ...
            <div className="relative group">
              ...
              <input type={showPassword ? "text" : "password"} placeholder="Create password" className="w-full bg-[#18181b] border border-white/10 rounded-xl px-11 py-3 text-white placeholder:text-white/20 focus:outline-none focus:border-[#ffae34]/50 focus:ring-1 focus:ring-[#ffae34]/50 transition-all text-sm" />
          ...
          <div className="flex items-start gap-2 pt-1">
            <input type="checkbox" id="terms" className="mt-1 accent-[#ffae34] w-4 h-4 bg-white/10 border-white/20 rounded cursor-pointer" />
            <label htmlFor="terms" className="text-xs text-white/50 cursor-pointer">
              I agree to the <a href="#" className="text-[#ffae34] hover:underline">Terms of Service</a> & <a href="#" className="text-[#ffae34] hover:underline">Privacy Policy</a>
            </label>
          </div>
        ...
        <div className="mt-8 pt-6 border-t border-white/10 text-center">
          <p className="text-white/40 text-sm">
            Already have an account? <a href="/login" className="text-[#ffae34] font-medium hover:underline ml-1">Log in</a>
          </p>
        </div>
      </div>
    </div>
