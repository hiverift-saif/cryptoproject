...
const HeroSection = () => {
  ...
  return (
    // CHANGE 1: 'pt-5' ko 'pt-2' kiya taaki mobile pr upar space kam ho
    <div className="min-h-screen w-full bg-black text-[#eceae9] font-sans flex flex-col items-center justify-center px-4 pt-2 md:pt-0 ">
      
      {/* =========================================
          SECTION 1: ANIMATED CARD (Auto Rotating)
         ========================================= */}
      {/* CHANGE 2: 'h-16' hataya aur 'mb-6' ko 'mb-3' kiya (Space Reduced) */}
      <div className="mb-3 flex items-center justify-center">
        ...
        >
          ...
          {/* Name */}
          <p className="text-[#eceae9] font-medium text-xs md:text-sm whitespace-nowrap">
            {currentAsset.name}
          </p>

          {/* Percentage + Arrow */}
          <div className={`flex items-center gap-1 text-[10px] md:text-xs font-bold ${
              currentAsset.isPositive ? "text-[#5ddf38]" : "text-[#ff4747]"
            }`}
          >
            <span>{currentAsset.percent}</span>
            {currentAsset.isPositive ? (
              <ArrowUpRight size={14} strokeWidth={2.5} className="md:w-4 md:h-4" />
            ) : (
              <ArrowDownRight size={14} strokeWidth={2.5} className="md:w-4 md:h-4" />
            )}
          </div>
        </div>
      </div>
      ...
      {/* =========================================
          SECTION 2: MAIN CONTENT (Title & Buttons)
         ========================================= */}
      
      {/* 2. MAIN TITLE */}
      <h1 className="
        text-[#cccac9] 
        text-[32px] sm:text-[40px] md:text-[70px] 
      ...
      {/* 5. TRUSTPILOT RATING */}
      <div className="flex items-center gap-2 text-[#afadac] text-xs md:text-sm font-medium py-5">
      ...
      {/* =========================================
          SECTION 3: VIDEO (Centered & Smaller)
         ========================================= */}
      <div className="w-full flex justify-center mb-8 px-2 md:px-4">
        <div className="
          relative w-full 
          max-w-[1100px]
          bg-white/5
        ...
        ">
          ...
          ">
            <video
              src="https://bvmwebsolutions.com/equlix/new/images/equlix.mp4"
